        ...
        child: Card(
          ...
          child: Row(
            children: <Widget>[
                        ...
                        children: <Widget>[
                          ...
                          (this.backgroundColor == null && leftBadge != null)
                              ? Image(
                                  height: 60.0,
                                  image: AssetImage(
                                      "assets/images/card/triangle_left.png"),
                                )
                              : Container(),
                        ],
                      ),
              ...
              (this.backgroundColor != null && leftBadge != null)
                  ? Image.asset(
                      "assets/images/card/triangle_inv_left.png",
                      height: 60.0,
                    )
                  : Container(),
              Expanded(
              ...
              (this.backgroundColor != null && this.rightBadge != null)
                  ? Image(
                      height: 60.0,
                      image: AssetImage("assets/images/card/triangle_inv_right.png"),
                    )
                  : Container(),
                        ...
                        children: <Widget>[
                          (this.backgroundColor == null)
                              ? Image(
                                  height: 60.0,
                                  image: AssetImage(
                                      "assets/images/card/triangle_right.png"),
                                )
                              : Container(),
                          Expanded(
                            flex: 1,
